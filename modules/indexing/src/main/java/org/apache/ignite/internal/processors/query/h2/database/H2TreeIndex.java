...
public class H2TreeIndex extends H2TreeIndexBase {
    ...
    @Override public Cursor find(Session ses, SearchRow lower, SearchRow upper) {
        ...
        try {
            ...
            GridCursor<IndexRow> cursor = queryIndex.find(key.get1(), key.get2(), segment(qctx), idxQryContext(qctx), null);
    ...
    public Iterator<H2Row> findForSegment(GridH2RowRangeBounds bounds, int segment, IndexQueryContext qryCtx) {
        ...
        try {
            GridCursor<IndexRow> range = queryIndex.find(key.get1(), key.get2(), segment, qryCtx, null);
