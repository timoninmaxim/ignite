...
public class IncrementalSnapshotVerification {
     ...
     *
     */
    public IncrementalSnapshotVerificationTask(IgniteEx ignite, IgniteLogger log, SnapshotFileTree sft,
        int incrementalIdx) {
        this.ignite = ignite;
        this.sft = sft;
    ...
    /** */
    public IdleVerifyResult reduce(
        Map<ClusterNode, IncrementalSnapshotVerificationTaskResult> results) throws IgniteException {
