...
/** */
public class RecoveryConsistentSegments extends IgniteDataTransferObject {
    /** */
    ...
    /** */
    public RecoveryConsistentSegments(
        @Nullable List<ConsistentCutVersion> cutVers,
    ...
    /** */
    public @Nullable Collection<ConsistentCutVersion> cutVersions() {
        return cutVers;
    }

    /** */
    public @Nullable Map<ClusterNode, Exception> exceptions() {
        return exceptions;
    }
    ...
    @Override protected void writeExternalData(ObjectOutput out) throws IOException {
        ...
        U.writeCollection(out, cutVers);
    }

    /** {@inheritDoc} */
    @Override protected void readExternalData(byte protoVer, ObjectInput in) throws IOException, ClassNotFoundException {
        exceptions = U.readMap(in);
        cutVers = U.readCollection(in);
    }
}
